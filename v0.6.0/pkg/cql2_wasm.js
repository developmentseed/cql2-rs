export class Expr {
    ...
    equals(other) {
        _assertClass(other, Expr);
        const ret = wasm.expr_equals(this.__wbg_ptr, other.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    is_valid() {
        const ret = wasm.expr_is_valid(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    matches(item) {
        const ret = wasm.expr_matches(this.__wbg_ptr, item);
        if (ret[2]) {
    ...
    constructor(v) {
        ...
        const ret = wasm.expr_new(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
     ...
     */
    reduce(item) {
        const ret = wasm.expr_reduce(this.__wbg_ptr, item);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
    ...
    to_ducksql() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.expr_to_ducksql(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     */
    to_json() {
        const ret = wasm.expr_to_json(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
    ...
    to_json_pretty() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.expr_to_json_pretty(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
    ...
    to_sql() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.expr_to_sql(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
    ...
    to_text() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.expr_to_text(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     */
    validate() {
        const ret = wasm.expr_validate(this.__wbg_ptr);
        if (ret[1]) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./cql2_wasm_bg.js": import0,
    };
}

const ExprFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_expr_free(ptr, 1));
